				...
				function($scope, $http, $filter, $window) {
					...
					$scope.checkEnrollment = function() {
						var checkEnrollment = "" + HOST_NAME
								+ "/superadmin/student/isEnrollmentNum/"
					...
					$scope.loadAllData = function() {
						...
						var getStudent = "" + HOST_NAME
								+ "/superadmin/student/all";

						var getDropDownDivision = "" + HOST_NAME
								+ "/superadmin/student/divdropDown";

						var getBloodGroups = "" + HOST_NAME
								+ "/superadmin/student/dropDownBloodGroup";

						$http.get(getBloodGroups).then(function(response) {
							$scope.bloodGroupsList = response.data;

						});

						$http.get(getStudent).then(function(response) {
					...
					$scope.deleteSelected = function() {
						...
						if (rows_selected.length === 0) {
							...
							var deleteLink = "" + HOST_NAME
									+ "/superadmin/student/deleteItems/"
									+ rows_selected + "";
					...
					$scope.deleteStudent = function(studentId, index) {
						...
						var deleteLink = "" + HOST_NAME
								+ "/superadmin/student/deleteSingleItem/"
								+ studentId + "";
					...
					$scope.submit = function() {
						...
						var link = "" + HOST_NAME + "/superadmin/student/post";
