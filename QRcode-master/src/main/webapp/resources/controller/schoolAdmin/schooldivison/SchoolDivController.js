				...
				function($scope, $http, $filter, $window) {
					...
					$scope.loadAllData = function() {
						...
						var getSchool = "" + HOST_NAME
								+ "/schooladmin/schoolDivison/dropDown";

						var getDropDownTeach = "" + HOST_NAME
								+ "/schooladmin/schoolDivison/dropDowntecher";
						var getDropDownCoteach = "" + HOST_NAME
								+ "/schooladmin/schoolDivison/dropDowntecherco";
					...
					$scope.deleteSelected = function() {
						...
						if (rows_selected.length === 0) {
							...
							var deleteLink = ""
									+ HOST_NAME
									+ "/schooladmin/schoolDivison/divisiondeleteItems/"
									+ rows_selected + "";
					...
					$scope.deleteSchoolDiv = function(schoolId, index) {
						...
						var deleteLink = ""
								+ HOST_NAME
								+ "/schooladmin/schoolDivison/divisiondeleteSingleItem/"
								+ schoolId + "";
					...
					$scope.submit = function() {
						...
						var link = "" + HOST_NAME
								+ "/schooladmin/schoolDivison/post";
					...
					$scope.remove = function() {
						...
						var newDataList = [];
						$scope.selectedAll = false;
						angular.forEach($scope.divisionList,
								function(selected) {
									if (!selected.selected) {
										newDataList.push(selected);
									} else {
										rows_selected
												.push(selected.schoolDivId);
									}
								});
